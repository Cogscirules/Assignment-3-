...
rmse_model_test = modelr::rmse(bm_001, test_data)
...
#bernie, actual avergae td, predicted child mlu

b_p = predict(model1, bernie, interval = "prediction")
summary(b_p)

nd_pred_bernie = data.frame(bernie, mlu, b_p)

ggplot(nd_pred_bernie, aes(visit, temp$avg_mlu, fill = subj_id))+geom_bar(stat="identity", position = "dodge")
